...
namespace Northwind.RepoV1.Test
{
    public class Tests
    {
        ...
        public void TestGetAllWithPage()
        {
            ...
            CollectionAssert.AreEqual(result.Select(x => x.EmployeeId), _dbContext.Employees.Skip(1).Take(1).Select(x => x.EmployeeId));
        }
        ...
        public void TestGetAllWithPredicatePage()
        {
            ...
            CollectionAssert.AreEqual(result.Select(x => x.EmployeeId), _dbContext.Employees.Where(x => x.EmployeeId > 1).Skip(1).Take(1).Select(x => x.EmployeeId));
        }
        ...
        public void TestGetAllWithPredicatePageInclude()
        {
            ...
            CollectionAssert.AreEqual(result.Select(x => x.ReportsToNavigation.EmployeeId),anwser
                );
        }
        ...
        public void TestSelect()
        {
            ...
            Assert.That(_unitOfWork.EmployeeRepository.Select(x => x.EmployeeId > 0, 2, 2, x => x.EmployeeId), Is.EqualTo(Enumerable.Range(3, 1)));
        }
        ...
        public async Task TestSelectAsync()
        {
            ...
            Assert.That(await _unitOfWork.EmployeeRepository.SelectAsync(x => x.EmployeeId > 0, 2, 2, x => x.EmployeeId), Is.EqualTo(Enumerable.Range(3, 1)));
        }
